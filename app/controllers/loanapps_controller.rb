class LoanappsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @loanapp.save
        flash[:notice] = 'Thank you. Your loan application has been submitted.'
		#send email
		Emailer.deliver_loanapp_email(@loanapp)
		Emailer.deliver_tosender_email(@loanapp.applicant_email_address, "Thank You. Your Loan Application was successfully sent. ")
